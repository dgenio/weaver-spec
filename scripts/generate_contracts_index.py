...
# Provenance stamp (#151): a machine-readable note recording that this file is
# generated and by which build-time script, so a consumer that reads only the
# artifact (not the repo) can trace it back to its producer. Bumped to
# schema_version 2 when this field was added.
INDEX_PROVENANCE = (
    "Generated by scripts/generate_contracts_index.py from contracts/json/. "
